...
import { editMeetup, getMeetup } from "../../actions/meetupActions";
...
class EditMeetup extends Component {
  ...
  editMeetup = () => {
    ...
    this.props.editMeetup(newMeetup);
  };
            ...
            <div className="row justify-content-center">
              <div className="title col-12 col-lg-8">
                ...
                <h3 className="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-6">
                  Easily change location or title for your next big meetup and
                  you are done.
                </h3>
              </div>
            </div>
                  ...
                  <div className="row row-sm-offset">
                    ...
                    <div className="col-md-5 multi-horizontal">
                      <div className="form-group">
                        ...
                        <TimePicker
                          showSecond={false}
                          value={moment(date + " " + to)}
                          defaultValue={moment(date + " " + to)}
                          className="form-control"
